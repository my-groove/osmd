...
>>>>>>> 1a2ef95b2ec9c05ddcb3342070fe4de020924c31
        ...
        if (osmdTestMode) {
            if (!osmdTestSingleMode && sampleFilename.startsWith("Beethoven") && sampleFilename.includes("Geliebte")) {
                ...
                await generateSampleImage(sampleFilename, sampleDir, osmdInstance, osmdTestMode, {
                    skyBottomLine: true, fileNameAddition: "skyBottomLine"
                }, DEBUG);
                // generate one more testing image with GraphicalNote positions
                await generateSampleImage(sampleFilename, sampleDir, osmdInstance, osmdTestMode, {
                    drawBoundingBoxString: "VexFlowGraphicalNote", fileNameAddition: "bboxVexFlowGraphicalNote_"
                }, DEBUG);
                ...
                await generateSampleImage(sampleFilename, sampleDir, osmdInstance, osmdTestMode, {
                    darkMode: true, fileNameAddition: "darkmode_"
                }, DEBUG);
                ...
                await generateSampleImage(sampleFilename, sampleDir, osmdInstance, osmdTestMode, {
                    staffVisibility: { 0: true, 1: false }, fileNameAddition: "right_hand_only_"
                }, DEBUG);
                await generateSampleImage(sampleFilename, sampleDir, osmdInstance, osmdTestMode, {
                    staffVisibility: { 0: false, 1: true }, fileNameAddition: "left_hand_only_"
                }, DEBUG);
            }
        }
    }
